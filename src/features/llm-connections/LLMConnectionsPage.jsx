/**
 * LLMConnectionsPage.jsx — Page 14: LLM Connections Configuration
 *
 * Purpose: Manage and display all available LLM model providers.
 * - Fetches live provider list from NestJS (/ai/models) which proxies to Mastra.
 * - Displays 5 provider cards: Groq, Google Gemini, Ollama, OpenAI, LM Studio.
 * - Allows saving API keys, custom base URLs, default model selection.
